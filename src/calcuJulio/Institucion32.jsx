...
function Institucion32() {
  ...
  useEffect(() => {
    const deduccionesImporte2 =
      ...
      parseFloat(impuestoGanancias) +
      parseFloat(descuento);
    setDescuentoLey22(deduccionesImporte2);
  }, [
    jubilacion,
    serosTitular,
    serosFamiliar,
  ...
  useEffect(() => {
    ...
    setNetoInstitucion22(sumaParaAtech.toFixed(2));
  }, [
    sueldo,
    PorcentajPd,
    zonaImporte,
  ...
  return (
    <div>
      ...
      <h2 className="subtituloMes">Julio</h2>
      <span style={{color:"black",fontFamily:"cursive"}}>(Esta actualización no incluye las modificaciones de adicional remunerativo no bonificable<br/> otorgado a cargos directivos, secretarios ni supervisión)</span>
