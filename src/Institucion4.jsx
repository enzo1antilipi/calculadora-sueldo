...
function Institucion4() {
  ...
  useEffect(() => {
    const deduccionesImporte2 =
      ...
      parseFloat(impuestoGanancias) +
      parseFloat(descuento);
    setDescuentoLey5(deduccionesImporte2);
  }, [
    jubilacion,
    serosTitular,
    serosFamiliar,
  ...
  useEffect(() => {
    ...
    setNetoInstitucion5(sumaParaAtech.toFixed(2));
  }, [
    sueldo,
    zonaImporte,
    recursosMateriales,
  ...
  useEffect(() => {
    ...
    setRetencion5(afiliacion.toFixed(2));
  }, [sueldo2]);
