...
function Institucion01() {
  ...
  useEffect(() => {
    const deduccionesImporte2 =
      ...
      parseFloat(impuestoGanancias) +
      parseFloat(descuento);
    setDescuentoLey01(deduccionesImporte2);
  }, [
    jubilacion,
    serosTitular,
    serosFamiliar,
  ...
  useEffect(() => {
    ...
    setNetoInstitucion01(sumaParaAtech.toFixed(2));
  }, [
    sueldo,
    PorcentajPd,
    zonaImporte,
